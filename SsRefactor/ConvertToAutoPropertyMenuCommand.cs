...
{
    internal sealed class ConvertToAutoPropertyMenuCommand
    {
        ...
        private ConvertToAutoPropertyMenuCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        public static ConvertToAutoPropertyMenuCommand Instance { get; private set; }

        public static async Task InitializeAsync(AsyncPackage package)
        {
            await ThreadHelper.JoinableTaskFactory.SwitchToMainThreadAsync(package.DisposalToken);
            var commandService = await package.GetServiceAsync(typeof(IMenuCommandService)) as OleMenuCommandService;
            Instance = new ConvertToAutoPropertyMenuCommand(package, commandService);
        }
            ...
            try
            {
                ...
                else
                {
                    VsShellUtilities.ShowMessageBox(
                        this.package,
                        "Could not convert selected properties to auto properties.",
                        "SsRefactor",
